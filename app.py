...
models = {
    'mango': tf.keras.models.load_model('D:/000PProject/Harvest Website/Harvest3rdTrial/models/mango_model.h5', compile=False),
    'banana': tf.keras.models.load_model('D:/000PProject/Harvest Website/Harvest3rdTrial/models/banana_model.h5', compile=False),
    'corn': tf.keras.models.load_model('D:/000PProject/Harvest Website/Harvest3rdTrial/models/corn_model.h5', compile=False),
    'cotton': tf.keras.models.load_model('D:/000PProject/Harvest Website/Harvest3rdTrial/models/cotton_model.h5', compile=False),
    'eggplant': tf.keras.models.load_model('D:/000PProject/Harvest Website/Harvest3rdTrial/models/eggplant_model.h5', compile=False),
    'peach': tf.keras.models.load_model('D:/000PProject/Harvest Website/Harvest3rdTrial/models/peach_model.h5', compile=False),
    'pepper': tf.keras.models.load_model('D:/000PProject/Harvest Website/Harvest3rdTrial/models/pepper_model.h5', compile=False),
    'potato': tf.keras.models.load_model('D:/000PProject/Harvest Website/Harvest3rdTrial/models/potato_model.h5', compile=False),
    'rice': tf.keras.models.load_model('D:/000PProject/Harvest Website/Harvest3rdTrial/models/rice_model.h5', compile=False),
    'tomato': tf.keras.models.load_model('D:/000PProject/Harvest Website/Harvest3rdTrial/models/tomato_model.h5', compile=False),
    'grapes': tf.keras.models.load_model('D:/000PProject/Harvest Website/Harvest3rdTrial/models/grapes_model.h5', compile=False)
}
